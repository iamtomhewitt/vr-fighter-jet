...
namespace UnityStandardAssets.Utility
{
	public class WaypointProgressTracker : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// Put in by Tom to stop a null pointer happening in Update()
			WaypointCircuit[] circuits = GameObject.FindObjectsOfType<WaypointCircuit>();
			circuit = circuits[UnityEngine.Random.Range(0, circuits.Length)].GetComponent<WaypointCircuit>();
